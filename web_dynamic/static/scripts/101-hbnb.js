...
function showApiStatus() {
	$.get('http://localhost:5000/api/v1/status/', function (data, status) {
		if (status === 'success') {
...
function review(reviewObj){
	...
	$.ajax({
		url: `http://localhost:5000/api/v1/users/${reviewObj.user_id}`,
		type: 'GET',
		dataType: 'json',
...
function showReviews(place_id) {
	...
	$.ajax({
		url: `http://localhost:5000/api/v1/places/${place_id}/reviews`,
		type: 'GET',
		dataType: 'json',
		contentType: 'application/json',
